  ...
  return (
    <section className="min-h-screen w-full flex flex-col relative" id="home">
      ...
      {/* <div className="absolute bottom-7 left-0 right-0 w-full z-10 flex justify-center">
        <button className="resume-btn" onClick={() => setIsModalOpen(true)}>
          View My Resume
        </button>
      </div> */}
      <div className="absolute bottom-7 left-0 right-0 w-full z-10 c-space resume-btn">
  <a href="#" onClick={(e) => { e.preventDefault(); setIsModalOpen(true); }} className="w-fit">
