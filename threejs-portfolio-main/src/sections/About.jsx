...
const About = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('nishantchorpa2020@gmail.com');
    setHasCopied(true);
      ...
      <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
        <div className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            ...
            <div>
              <p className="grid-headtext">Hi, I’m Nishant Chopra</p>
        ...
        <div className="col-span-1 xl:row-span-4">
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">I&apos;m based in Udaipur, Rajasthan and open to remote work worldwide.</p>
